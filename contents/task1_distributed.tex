...
\begin{figure}[!htb]
	...
	\caption[Comparison of losses of the first set of experiments.]{Comparison of 
...
\begin{figure}[!htb]
	...
	\begin{tabular}{ccccc}
		...
		\bottomrule
	\end{tabular}
	\captionof{table}{List of the experiments carried out using a variable number of 
