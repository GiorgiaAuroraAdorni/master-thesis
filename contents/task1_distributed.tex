...
\end{figure}
After about $10$ time steps they both reach the target, with a 
certain tolerance, maintaining then the speed constant at $0$. Instead, the 
distributed controller decreases the speed of the agents as the time steps pass, 
...
time, in Figure \ref{fig:net-d6control}, highlights the speed of the expert 
controller, which in all the simulation runs after $25$ time steps has reached the 
goal. 
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[h]{0.3\textwidth}
		...
		\caption{Distributed controller.}
	\end{subfigure}
	\caption[Evaluation of the control learned by \texttt{net-d6}.]{Comparison 
		of output control generated using three controllers: the expert, the manual 
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[h]{0.3\textwidth}
		...
		\caption{Distributed controller.}
	\end{subfigure}
	\caption[Evaluation of the control learned by \texttt{net-d9}.]{Comparison 
		of output control generated using three controllers: the expert, the manual 
...
\begin{figure}[!htb]
	...
	\end{subfigure}
	\caption[Summary, in terms of loss, of the first set of experiments.]{Comparison 
...
%\begin{figure}[!htb]
%	\centering
%\includegraphics[width=.8\textwidth]{contents/images/task1/loss-distributed-gap_8@}%
%	\caption{Comparison of the losses of the .}
%	\label{fig:distloss8}
%\end{figure}
...
%\begin{figure}[!htb]
%	\centering
%\includegraphics[width=.8\textwidth]{contents/images/task1/loss-distributed-gap_13@}%
...
and \texttt{all\_sensors} still have excellent performances and very similar to each 
other.
%\begin{figure}[!htb]
%	\centering
%\includegraphics[width=.8\textwidth]{contents/images/task1/loss-distributed-gap_24@}%
%	\caption{Comparison of the losses of the models that use an \texttt{avg\_gap} 
%	of $24$\gls{cm}.}
...
\begin{figure}[H]
	...
	\begin{tabular}{ccccc}
		...
		\midrule
		\texttt{net-d10} 	& \texttt{all\_sensors}		&  $14$  &  $8$		 	 &	 
		$5$ \\
		\texttt{net-d11} 	& \texttt{all\_sensors}		&  $14$  &  $20$		&	$5$ \\
		\texttt{net-d12} 	& \texttt{all\_sensors}		&  $14$  &  variable   &	
		$5$ \\
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[h]{0.3\textwidth}
		...
		\caption{Distributed controller.}
	\end{subfigure}
	\caption[Evaluation of the control learned by \texttt{net-d12}.]{Comparison 
		of output control generated using three controllers: the expert, the 
		manual 
		and the one learned from \texttt{net-d12}.}
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[h]{0.3\textwidth}
		...
		\caption{Distributed controller.}
	\end{subfigure}
	\caption[Evaluation of the control learned by \texttt{net-d15}.]{Comparison 
		of output control generated using three controllers: the expert, the 
		manual 
		and the one learned from \texttt{net-d15}.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.67\textwidth]{contents/images/net-d15/distances-from-goal-compressed-distributed}%
...
\begin{figure}[!htb]
	...
	\begin{subfigure}[h]{0.3\textwidth}
		...
		\caption{Distributed controller.}
	\end{subfigure}
	\caption[Evaluation of the control learned by \texttt{net-d18}.]{Comparison 
		of output control generated using three controllers: the expert, the 
		manual and the one learned from \texttt{net-d18}.}
...
\begin{figure}[!htb]
	...
	\end{subfigure}
		\caption[Summary, in terms of loss, of the second set of 
