...
%Moreover, we show another metric for evaluating our model, the accuracy, 
%that 
%is the fraction of the number of correct predictions over the total number 
%of 
%samples. In this case the value obtained is not very satisfactory, as we reach 
%an 
%accuracy of only $66\%$.
...
To sum up, we finally show in the figures below the losses of the trained models as 
