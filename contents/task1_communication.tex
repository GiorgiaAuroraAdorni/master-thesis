...
system, showing the behaviour of the network trained using \texttt{all\_sensors} 
input, variable gaps and number of agents, applied on simulations with a higher 
number of robots, from 5 up to 50.
\begin{figure}[!htb]
	\centering
...
previous, even if the increasing number of robots still produces a slowdown in 
